...
yystate(28, [80|Ics], Line, Tlen, Action, Alen) ->
    yystate(26, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [73|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [58|Ics], Line, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [48|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [49|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 50, C =< 57 ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 57 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 43 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(19, Ics, Line, Tlen+1, 1, Tlen);
yystate(19, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 96 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 43 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 59, C =< 96 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 123 ->
    yystate(3, Ics, Line, Tlen+1, Action, Alen);
...
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
yystate(16, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
yystate(14, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(11, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 91, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 57 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(7, [49|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 43 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 50, C =< 57 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(3, Ics, Line, Tlen+1, 0, Tlen);
yystate(7, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(6, [10|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line+1, Tlen+1, 6, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 6, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 43 ->
    yystate(3, Ics, Line, Tlen+1, 6, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(4, Ics, Line, Tlen+1, 6, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(3, Ics, Line, Tlen+1, 6, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(1, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(5, [94|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 6, Tlen);
yystate(5, [48|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 6, Tlen);
yystate(5, [49|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 43 ->
    yystate(3, Ics, Line, Tlen+1, 6, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 50, C =< 57 ->
    yystate(4, Ics, Line, Tlen+1, 6, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(3, Ics, Line, Tlen+1, 6, Tlen);
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(1, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 43 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(4, Ics, Line, Tlen+1, 1, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 59, C =< 64 ->
    yystate(3, Ics, Line, Tlen+1, 1, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(1, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(2, [95|Ics], Line, Tlen, _, _) ->
    yystate(9, Ics, Line, Tlen+1, 1, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 47 ->
    yystate(9, Ics, Line, Tlen+1, 1, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(0, Ics, Line, Tlen+1, 1, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 45, C =< 57 ->
    yystate(9, Ics, Line, Tlen+1, 1, Tlen);
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(0, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 93 ->
    yystate(9, Ics, Line, Tlen+1, 2, Tlen);
...
yyaction_1(TokenChars, TokenLine) ->
     { token, { int, TokenLine, lists : droplast (TokenChars) } } .
...
yyaction_5(TokenChars, TokenLine) ->
     { token, { key, TokenLine, lists : droplast (TokenChars) }, ":" } .
